...
class RawMsterailStorageOutPaperCheck extends Form
{
    // 增加一个自定义属性保存用户ID
    protected $id;
    protected $data;
    ...
    {
        $this->id = $id;
        $this->data = RawMaterialStorageOutPaper::find($id);
        parent::__construct();
    }
    /**
    ...
    public function handle(array $input)
    {
        ...
        $info = RawMaterialStorageOutPaper::find($id);
        ...
        try{
            ...
            $info->void_user_id = Admin::user()->id;
            $info->void_user_name = Admin::user()->name;
            $info->save();
            DB::commit();

...
use App\Admin\Extensions\Forms\BoxLabelDispatchPaperCheck as BoxLabelDispatchPaperCheckForm;

class BoxLabelDispatchPaperCheck extends RowAction
{
...
HTML;
    ...
    {
        // 工具表单
        $form = new BoxLabelDispatchPaperCheckForm($this->getKey());
        // 刷新页面时移除模态窗遮罩层

...
use App\Admin\Extensions\Forms\RawMsterailStorageOutPaperCheck as RawMsterailStorageOutPaperCheckForm;

class RawMsterailStorageOutPaperCheck extends RowAction
{
...
HTML;
    ...
    {
        // 工具表单
        $form = new RawMsterailStorageOutPaperCheckForm($this->getKey());
        // 刷新页面时移除模态窗遮罩层

...
use App\Admin\Extensions\Forms\SoleWorkshopSubscribeDetailStatusChange as SoleWorkshopSubscribeDetailStatusChangeForm;

class SoleWorkshopSubscribeDetailStatusChange extends RowAction
{
    /**
     * @return string
     */
    ...
    {
        ;
        $id = "sole-workshop-purchase-status-{$this->getKey()}";
        // 模态窗
        $this->modal($id);
...
HTML1;
    ...
    {
        // 工具表单
        $form = new SoleWorkshopSubscribeDetailStatusChangeForm($this->getKey());
        // 刷新页面时移除模态窗遮罩层

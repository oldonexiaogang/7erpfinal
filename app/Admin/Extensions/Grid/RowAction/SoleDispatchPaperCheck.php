...
use App\Admin\Extensions\Forms\SoleDispatchPaperCheck as SoleDispatchPaperCheckForm;

class SoleDispatchPaperCheck extends RowAction
{
...
HTML;
    ...
    {
        // 工具表单
        $form = new SoleDispatchPaperCheckForm($this->getKey());
        // 刷新页面时移除模态窗遮罩层

...
use App\Admin\Extensions\Forms\DeliveryPaperCheck as DeliveryPaperCheckForm;

class DeliveryPaperCheck extends RowAction
{
...
HTML;
    ...
    {
        // 工具表单
        $form = new DeliveryPaperCheckForm($this->getKey());
        // 刷新页面时移除模态窗遮罩层

...
use App\Admin\Extensions\Forms\InjectMoldDispatchPaperCheck as InjectMoldDispatchPaperCheckForm;

class InjectMoldDispatchPaperCheck extends RowAction
{
...
HTML;
    ...
    {
        // 工具表单
        $form = new InjectMoldDispatchPaperCheckForm($this->getKey());
        // 刷新页面时移除模态窗遮罩层
